...
* The original package name 'com.github.fabriciolfj.inventary-service-imperativo' is invalid and this project uses 'com.github.fabriciolfj.inventaryserviceimperativo' instead.
...
```
$ docker run --rm -p 8080:8080 inventary-service-imperativo:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/inventary-service-imperativo
```
